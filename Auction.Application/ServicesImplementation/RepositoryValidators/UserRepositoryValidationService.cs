...
namespace OrderWebsite.Application.Services
{
    ...
    {
        private IConverterService<UserEntity, UserModel> userEntityToModelConverter;
        private IConverterService<UserModel, UserEntity> userModelToEntityConverter;
        private IUserRepository userRepository;
        private ILoggerService logger;
        public UserRepositoryValidationService(
            ILoggerService logger,
            IUserRepository userRepository,
            IConverterService<UserEntity,UserModel> userEntityToModelConverter,
            IConverterService<UserModel,UserEntity> userModelToEntityConverter)
        {
            this.logger = logger;
